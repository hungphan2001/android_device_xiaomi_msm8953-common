...
patchelf --remove-needed libfp_client.so "$DEVICE_BLOB_ROOT"/lib64/hw/gf_fingerprint.default.so
...
patchelf --remove-needed libfp_client.so "$DEVICE_BLOB_ROOT"/lib64/libgoodixfingerprintd_binder.so
...
patchelf --remove-needed libfp_client.so "$DEVICE_BLOB_ROOT"/vendor/lib64/libvendor.goodix.hardware.fingerprint@1.0-service.so
...
patchelf --remove-needed libfp_client.so "$DEVICE_BLOB_ROOT"/vendor/lib64/libvendor.goodix.hardware.fingerprint@1.0.so
